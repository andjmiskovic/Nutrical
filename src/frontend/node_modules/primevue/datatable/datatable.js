...
this.primevue.datatable = (function (utils, api, Paginator, VirtualScroller, vue, OverlayEventBus, Dropdown, Button, Portal, Ripple) {
    ...
    const _hoisted_3$6 = /*#__PURE__*/vue.createElementVNode("span", { class: "pi pi-filter-icon pi-filter" }, null, -1);
    const _hoisted_4$4 = [
      _hoisted_3$6
    ];
    const _hoisted_5$3 = /*#__PURE__*/vue.createElementVNode("span", { class: "pi pi-filter-slash" }, null, -1);
    const _hoisted_6$3 = [
      _hoisted_5$3
    ];
    const _hoisted_7$1 = {

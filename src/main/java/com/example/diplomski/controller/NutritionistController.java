...
public class NutritionistController {
    ...
    public void addClient(@RequestBody ClientRequest clientRequestDTO) throws NutritionistNotFoundException {
        clientService.addClient(clientRequestDTO);
    }

    @GetMapping("/get-clients")
    public List<BasicUserData> getClients(@RequestBody String email) throws NutritionistNotFoundException {
